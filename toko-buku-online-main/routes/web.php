...
Route::middleware(['auth:sanctum', 'verified'])->group(function () {
    ...
    Route::get('/ecommerce/products', [ProductController::class, 'index'])->name('products');
    Route::post('/ecommerce/products', [ProductController::class, 'store'])->name('add-product');
    Route::post('/ecommerce/products/{id}', [ProductController::class, 'update'])->name('update-product');
    Route::delete('/ecommerce/products/{id}', [ProductController::class, 'destroy'])->name('delete-product');
    Route::get('/ecommerce/category', [CategoryController::class, 'index'])->name('category');
    Route::post('/ecommerce/category', [CategoryController::class, 'store'])->name('add-category');
    Route::post('/ecommerce/category/{id}', [CategoryController::class, 'update'])->name('update-category');
    Route::delete('/ecommerce/category/{id}', [CategoryController::class, 'destroy'])->name('delete-category');
