...
if (document.getElementById("table-product") && typeof simpleDatatables.DataTable !== 'undefined') {
...
if (document.getElementById("category-product") && typeof simpleDatatables.DataTable !== 'undefined') {
  const dataTable = new simpleDatatables.DataTable("#category-product", {
      searchable: true,
      sortable: false
  });
}
