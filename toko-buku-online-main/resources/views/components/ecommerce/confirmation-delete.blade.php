@props(['id', 'type', 'route'])
<button type="button" data-modal-target="delete{{ $type }}{{ $id }}"
    data-modal-toggle="delete{{ $type }}{{ $id }}"
    class="focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm p-2.5 text-center inline-flex items-center me-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-4 md:p-5 text-center">
                ...
                <form action="{{ route($route, $id) }}" method="post">
                    ...
                    <button data-modal-hide="delete{{ $type }}{{ $id }}" type="button"
