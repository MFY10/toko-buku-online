<div class="col-span-full xl:col-span-8 bg-white dark:bg-gray-800 shadow-sm rounded-xl">
    <header class="px-5 py-4 border-b border-gray-100 dark:border-gray-700/60">
        <h2 class="font-semibold text-gray-800 dark:text-gray-100">Top Buku</h2>
    </header>
    <div class="p-3">
            ...
            <table class="table-auto w-full dark:text-gray-300">
                ...
                <thead
                    ...
                    <tr>
                        ...
                        <th class="p-2">
                            <div class="font-semibold text-center">Stok</div>
                        </th>
                        <th class="p-2">
                            <div class="font-semibold text-center">Terjual</div>
                        </th>
                        <th class="p-2">
                            <div class="font-semibold text-center">Keuntungan</div>
                        </th>
                    ...
                    <tr>
                        <td class="p-2">
                            <div class="flex items-center">
                                ...
                                <div class="text-gray-800 dark:text-gray-100">Buku 1</div>
                            </div>
                        </td>
                        <td class="p-2">
                    ...
                    <tr>
                        <td class="p-2">
                            <div class="flex items-center">
                                ...
                                <div class="text-gray-800 dark:text-gray-100">Buku 2</div>
                            </div>
                        </td>
                        <td class="p-2">
                    ...
                    <tr>
                        <td class="p-2">
                            <div class="flex items-center">
                                ...
                                <div class="text-gray-800 dark:text-gray-100">Buku 3</div>
                            </div>
                        </td>
                        <td class="p-2">
                    ...
                    <tr>
                        <td class="p-2">
                            <div class="flex items-center">
                                ...
                                <div class="text-gray-800 dark:text-gray-100">Buku 4</div>
                            </div>
                        </td>
                        <td class="p-2">
                    ...
                    <tr>
                        <td class="p-2">
                            <div class="flex items-center">
                                ...
                                <div class="text-gray-800 dark:text-gray-100">Buku 5</div>
                            </div>
                        </td>
                        <td class="p-2">
